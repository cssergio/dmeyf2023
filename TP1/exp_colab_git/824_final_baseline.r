...
dir.create("./exp/KA8240_baseline_exp_colab/", showWarnings = FALSE)
setwd("./exp/KA8240_baseline_exp_colab/")

# Configurar parámetros comunes
PARAM <- list()
PARAM$input$future <- 202107
PARAM$finalmodel$optim$num_iterations <- 320
PARAM$finalmodel$optim$learning_rate <- 0.134628124
PARAM$finalmodel$optim$feature_fraction <- 0.883025573
PARAM$finalmodel$optim$min_data_in_leaf <- 22235
PARAM$finalmodel$optim$num_leaves <- 390
