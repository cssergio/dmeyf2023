...
dir.create("./exp/KA8240_under_01_exp_colab/", showWarnings = FALSE)
setwd("./exp/KA8240_under_01_exp_colab/")

# Configurar parámetros comunes
PARAM <- list()
PARAM$input$future <- 202107
PARAM$finalmodel$optim$num_iterations <- 383
PARAM$finalmodel$optim$learning_rate <- 0.229956987
PARAM$finalmodel$optim$feature_fraction <- 0.795241002
PARAM$finalmodel$optim$min_data_in_leaf <- 8438
PARAM$finalmodel$optim$num_leaves <- 911
