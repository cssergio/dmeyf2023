...
dir.create("./exp/KA8240_under_03_exp_colab/", showWarnings = FALSE)
setwd("./exp/KA8240_under_03_exp_colab/")

# Configurar parámetros comunes
PARAM <- list()
PARAM$input$future <- 202107
PARAM$finalmodel$optim$num_iterations <- 940
PARAM$finalmodel$optim$learning_rate <- 0.141657917
PARAM$finalmodel$optim$feature_fraction <- 0.80420632
PARAM$finalmodel$optim$min_data_in_leaf <- 41374
